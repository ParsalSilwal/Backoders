...
class LogInWithEmailWrongCodeScreen
    extends GetWidget<LogInWithEmailWrongCodeController> {
  @override
                      ...
                      Padding(
                          ...
                          child: Obx(() => PinCodeTextField(
                              ...
                              pinTheme: PinTheme(
                                  ...
                                  selectedColor: ColorConstant.red500,
                                  activeColor: ColorConstant.red500)))),
                      Align(
                          alignment: Alignment.center,
                          child: Padding(
                              padding: getPadding(top: 36),
                              child: Text("msg_wrong_code_please".tr,
                                  overflow: TextOverflow.ellipsis,
                                  textAlign: TextAlign.left,
                                  style: AppStyle.txtInterRegular16Red50001
                                      .copyWith(
                                          height: getVerticalSize(1.03))))),
                      Align(
                          alignment: Alignment.center,
                          child: Padding(
                              padding: getPadding(top: 92, bottom: 5),
                              child: Row(
